    ...
    var i = {
      ...
      a = function (e) {
        e || (e = n.triggerElement),
          !0 !== m(e) &&
            ("dropdown" === v(e) ? U(e) : "accordion" === v(e) && S(e),
...
var KTLayoutSearch = (function () {
  ...
  return {
    init: function () {
      (e = document.querySelector("#kt_header_search_modal")) &&
...
var KTLayoutSidebar = (function () {
    ...
    if (r) {
      var a = new ApexCharts(r, {
          ...
          xaxis: {
            ...
            axisBorder: { show: !1 },
            axisTicks: { show: !1 },
            labels: { style: { colors: "#823FD9", fontSize: "12px" } },
          },
          yaxis: {
            crosshairs: { show: !1 },
            labels: { style: { colors: "#823FD9", fontSize: "12px" } },
  ...
  return {
    init: function () {
      var t, n;
      (t = document.querySelector("#kt_user_chart")),
        (n = parseInt(KTUtil.css(t, "height"))),
        t &&
          new ApexCharts(t, {
            series: [74],
            chart: { fontFamily: "inherit", height: n, type: "radialBar" },
            plotOptions: {
              radialBar: {
                hollow: { margin: 0, size: "78%" },
                dataLabels: {
                  showOn: "always",
                ...
                track: { background: "#00A3FF", strokeWidth: "100%" },
              },
            },
            colors: ["#F1416C"],
        ...
        e(
          "#kt_sidebar_tab_1",
          "#kt_sidebar_tab_1_chart",
          [40, 30, 25, 40, 50, 30],
          !1
        ),
        e(
          "#kt_sidebar_tab_2",
          "#kt_sidebar_tab_2_chart",
          [30, 30, 25, 45, 30, 40],
          !1
        ),
        e(
          "#kt_sidebar_tab_3",
          "#kt_sidebar_tab_3_chart",
          [25, 30, 40, 30, 35, 30],
          !0
        ),
        e(
          "#kt_sidebar_tab_4",
          "#kt_sidebar_tab_4_chart",
          [25, 30, 35, 40, 50, 30],
          !1
        ),
        e(
          "#kt_sidebar_tab_5",
          "#kt_sidebar_tab_5_chart",
          [40, 20, 50, 50, 55, 45],
          !1
        );
    },
